...
//!
//! ```
//! use rumps_types::{TransactionId, TransactionState, TransactionMetadata, TransactionTimestamp};
//!
...
///
/// ```
/// use rumps_types::TransactionState;
///
...
///
/// ```
/// use rumps_types::TransactionTimestamp;
///
...
///
/// ```
/// use rumps_types::IsolationLevel;
///
...
///
/// ```
/// use rumps_types::{TransactionId, TransactionMetadata, TransactionTimestamp};
///
/// // Create a new transaction
...
pub struct TransactionMetadata {
    ...
    pub commit_timestamp: Option<TransactionTimestamp>,
...
impl TransactionMetadata {
    ...
    pub fn commit(mut self, timestamp: TransactionTimestamp) -> Self {
